...
<div className='container'>
      ...
      <div className=" flex justify-between ">
        ...
        <div className="flex justify-center align-middle mt-20">
          <a href="https://behance.net/macfd" 
            className='mb-11 px-2 scale-50'>
              <img src={behance} 
              alt='behance'/>
          </a>

          <a href="https://twitter.com/jeremiahdsamuel" 
            className='px-2 scale-75'>
              <img src={twitter} 
              alt='twitterX'/>
              </a>
          ...
          <a href="https://github.com/livinalt" 
            className='px-2 scale-75'>
              <img src={github} 
              alt='git-hub'/></a>
